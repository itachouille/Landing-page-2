    ...
    <section className="pt-20">
      <div className="relative mx-auto flex w-[1000px] justify-between">
        <div className="pt-28">
          ...
          <p className="w-[500px] pt-4 text-lg font-medium text-black/50">
            The expectation that productivity should always lead to tangible
            results or accomplishments.
          </p>
        </div>

        <div className="flex h-[300px] w-[350px] flex-col justify-between rounded-3xl border bg-gradient-to-b from-white to-[#F1F1F1] p-8">
          <img className="h-auto w-36" src={Bubble} alt="Bubble's logo" />
          <div className="flex">
            <div className="flex flex-col">
              <span className="text-lg">Employees</span>
              <span className="text-black/50">1200+</span>
            </div>
            <div className="ml-6 flex flex-col">
              <span className="text-lg">Growth</span>
              <span className="text-black/50">Reviewed</span>
            </div>
          </div>
          <div className="flex flex-col">
        ...
        <div className="absolute -bottom-28 -right-48 flex h-[160px] w-[350px] justify-between rounded-3xl border bg-gradient-to-b from-white to-[#F1F1F1] p-8">
          ...
          <div className="relative">
            <div className="flex flex-col">
              ...
              <span className="pt-2 text-lg text-[#808080]">
                doe_jane@mail.com
              </span>
            </div>
